            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="InputData_2111501611.php" class="dropdown-item active">Input Data Uji</a>
...
<div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Input Data Uji</h6>
                            <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Input Data Bersih</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                    <div  class="form-text">Input Kategori Actual
                                    </div>
                                </div>
                            <select class="form-select" multiple aria-label="multiple select example">
                            <?php
            include "Koneksi_2111501611.php";
            include "Fungsi_2111501611.php";
            ...
            $ket="";
            if (isset($_GET['nm_kategori'])) {
            $kategori = trim($_GET['nm_kategori']);
            ...
            ?>
            <option 
            <?php echo $ket; ?> value="<?php echo $data['id_kategori'];?>"><?php echo $data['nm_kategori'];?>
            </option>
            <?php
            }
            ?>
...
if (isset($_POST['submit'])) {
    $data = $_POST['data'];
    $id = $_POST['id'];
    $x = simpandatauji($conn,$data,$id);
    echo "<script>alert('$x')</script>"; 
}
?>

<td colspan="2"> <input type="submit" class="btn btn-primary" name="submit" value="Simpan Data Uji"></td>
