        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">Arif Firmansyah</h6>
                        <span>mahasiswa</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <a href="idf.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Idf</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Arif Firmansyah</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
...
if ($result->num_rows == 0) {
    ...
    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tahap Idf</h6>
                            <div class="table-responsive">
                                <table class="table">
        <td colspan="3"><strong>Daftar Perhitungan Idf</strong></td>
    </tr>
    <tr bgcolor="#191C24">
    <th>No.</th>
    <th>Term</th>
 ...
 <div class="col-12">
    ...
    <tr bgcolor="#191C24">
       ...
       $sql = "SELECT * from tf_idf_2111501611 where id='$i' AND term='$kategori' AND document='$D' AND term_frequency='$DF' AND inverse_document_frequency='$IDF' AND tf_idf='$TF'";

       if($result->num_rows == 0) {
            //save to database
            $q = "INSERT into tf_idf_2111501611 (id,term,document,term_frequency,inverse_document_frequency,tf_idf)
                    VALUES('$i','$kategori','$D','$DF','$IDF','$TF')";

            $result = mysqli_query($conn,$q);
        }else { 
            $q = "UPDATE tf_idf_2111501611 set id='$i', term='$kategori', document='$D', term_frequency='$DF',
            inverse_document_frequency='$IDF', tf_idf='$TF'";   
        $result = mysqli_query($conn,$q);
}
        $i=$i+1;
    }
