        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Klasifikasi Data Uji</a>
                        <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="Akurasi_2111501611.php" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Akurasi Data</a>
...
function accuracy($conn) {
  $correct = 0;

  // Ambil jumlah dokumen keseluruhan
  $total_query = "SELECT COUNT(*) as total FROM classify_2111501611";
  $total_result = mysqli_query($conn, $total_query);
  $total_row = mysqli_fetch_array($total_result);
  $total = $total_row['total'];


  $correct_query = "SELECT COUNT(*) as correct FROM classify_2111501611 WHERE id_actual = id_predicted";
  $correct_result = mysqli_query($conn, $correct_query);
  $correct_row = mysqli_fetch_array($correct_result);
...
$acc = accuracy($conn);
echo "   Nilai Akurasi Hasil Klasifikasi : " . $acc . "\n";
?>
