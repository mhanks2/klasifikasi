        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="pengukuran_2111501611.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Pengukuran</a>
...
<head>
    <title> Tahap pengukuran kinerja Klasifikasi data dengan algortima naive Bayes</title>
...
<body>
    ...
    <?php
            ...
            $benar = getDokumenBenar($conn);
            $all = getDokumenAll($conn);
            $akurasi = ($benar / $all) * 100;
            echo " ==> Nilai Akurasi Yang didapat:(".$benar."/".$all.") x 100 =".$akurasi;
    ...
    <?php
    echo " ===> NILAI PRECISION DIDAPAT:" . ($tot / ($i - 1)) * 100;
    }
    require_once "Recall_2111501611.php";
    ?>
</body>
