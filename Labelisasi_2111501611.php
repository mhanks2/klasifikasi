...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Labelisasi_2111501611.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Labelisasi</a>
        ...
        <div class="content">
            ...
            <?php
include 'Koneksi_2111501611.php';
include "Stopword_2111501611.php";

$sql = "SELECT * FROM galert_data_2111501611 where length(galert_id)!=0";
            ...
            <!-- Table Start -->
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tabel Tahap Labelisasi</h6>
...
<tr bgcolor="#191C24">
    ...
    $sql = "SELECT * FROM kategori_2111501611 where nm_kategori='$kategori'";
    $result1 = $conn -> query($sql);

    if ($result1 -> num_rows == 0){
        $q = "INSERT INTO kategori_2111501611(nm_kategori)
            VALUES ('$kategori')";

            $result1= mysqli_query($conn,$q);
    }

$sql = "SELECT id_kategori From kategori_2111501611 where nm_kategori='$kategori'";
...
$sql = "SELECT * FROM galert_entry_2111501611 where feed_id='$id'";
$result2 = $conn->query($sql);

if ($result2->num_rows > 0) {
$q = "UPDATE preprocessing_2111501611 set id_kategori='$id_kategori'
            where entry_id in(SELECT entry_id FROM galert_entry_2111501611 where feed_id='$id')";
...
$i=1;
$sql = "SELECT * FROM preprocessing_2111501611 where length(entry_id)!=0";
$result = $conn->query($sql);
if ($result->num_rows == 0) {
    echo "Data Tidak Ditemukan";
}else{
    ...
    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tahap Labelisasi</h6>
                            <div class="table-responsive">
                                <table class="table">
    ...
    while($d = mysqli_fetch_array($result)){
        ...
        $id_kategori = $d['id_kategori'];
            ...
            $sql = "SELECT nm_kategori FROM kategori_2111501611 where id_kategori='$id_kategori'";
            $result2 = $conn->query($sql);
