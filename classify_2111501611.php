                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="classify_2111501611.php" class="dropdown-item active">Klasifikasi Data Uji</a>
                        </div>
...
$sql = "SELECT * from classify_2111501611  where id_predicted is null";
...
if ($result->num_rows == 0) {
    ...
    while ($d = mysqli_fetch_array($result)) {
        ...
        foreach ($data_array as $value) {
            ...
            $sql = "SELECT * from p_Data_2111501611  where kata='$kata'";
            ...
            if ($result2->num_rows > 0) {
                while ($d = mysqli_fetch_array($result2)) {
                    ...
                    $sql = "SELECT * from p_Kategori_2111501611  where id_kategori='$id'";
                    $result3 = $conn->query($sql);

                    if ($result3->num_rows > 0) {
                        $q = "UPDATE p_Kategori_2111501611  set tmp_nilai=$totnilai
        ...
        echo " ==> Kategori Tertinggi : ".getKat($conn,$id_kategori);" (".$nilaitertinggi." )";

        $sql = "SELECT * from Classify_2111501611  where data_bersih='$data'";
        $result4 = $conn->query($sql);
        
        if ($result4->num_rows > 0) {
            $q = "UPDATE Classify_2111501611 set id_predicted=$id_kategori
            where data_bersih='$data'";

            $result4 = mysqli_query($conn,$q);
        }

        $q = "UPDATE p_Kategori_2111501611  set tmp_nilai=0";
        $result3 = mysqli_query($conn,$q);
    }
}
?>
