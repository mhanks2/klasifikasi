        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Preprocessing_2111501611.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Preprocecing</a>
...
$sql = "SELECT k_tbaku,concat(k_baku,' ')k_baku FROM slangword_2111501611 ";
...
$sql = "SELECT * FROM galert_entry_2111501611 where length(entry_id)!=0";
...
<?php
        ...
        $sql = "SELECT * FROM preprocessing_2111501611 where entry_id='$id'";
        $result1 = $conn->query($sql);
        
        if($result1->num_rows == 0) {
            //save to database
            $q = "INSERT INTO preprocessing_2111501611 (entry_id,p_cf,p_simbol,p_tokenisasi,p_sword,p_stopword,p_stemming,data_bersih)
                    VALUES('$id','$cf','$simbol','$tokenisasi','$slangword','$stopword','$stemming','$stemming')";

            $result1 = mysqli_query($conn,$q);
        }else {

                        $q = "UPDATE preprocessing_2111501611 set p_cf='$cf', p_simbol='$simbol', p_tokenisasi='$tokenisasi', p_sword='$slangword',
