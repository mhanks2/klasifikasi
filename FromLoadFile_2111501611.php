...
<body>
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="FromLoadFile_2111501611.php" class="dropdown-item active">Input Data</a>
        ...
        <div class="content">
            ...
            <!-- Table End -->
            <form action="LoadFile_2111501611.php" method="get">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Input Link XML</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                    <div  class="form-text">Input Link XML Dari Google Allert
                                    </div>
                                </div>
